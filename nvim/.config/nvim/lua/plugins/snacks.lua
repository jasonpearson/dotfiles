return {
	...
	init = function()
		...
		vim.api.nvim_set_hl(0, "SnacksDashboardKey", { fg = "#94e2d5" })
		vim.api.nvim_set_hl(0, "SnacksDashboardDesc", { fg = "#94e2d5" })
		vim.api.nvim_set_hl(0, "SnacksDashboardFooter", { fg = "#94e2d5" })
	end,
	---@type snacks.Config
	opts = {
